...
class market :
    ...
    def test_all(self) :
        ...
        for model in self.all :
            ...
            print('Model accuracy over 60% is :', np.round(self.accuracy_test_trade,2))
            ...
            print('Model accuracy over 60% is :', np.round(self.accuracy_live_trade,2))
            ...
            pass_threshold = 56 #+ (n_best_models/150)
            percent_days = 10/100
